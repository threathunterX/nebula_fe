...
class Drawer extends Component {
  static propTypes = {
     ...
     */
    overlayStyle: PropTypes.oneOfType([PropTypes.object]),
    /**
  ...
  onBodyTouchStart = (event) => {
    ...
    if (swipeAreaWidth !== null && !this.state.open) {
      ...
      } else if (touchStartX > swipeAreaWidth) {
        return;
      }
    }
  ...
  setPosition(translateX) {
    const drawer = this.clickAwayableElement;
    ...
    return (
      ...
      >
        ...
        <div
          ...
          ref={node => (this.clickAwayableElement = node)}
        >
          <Paper
            zDepth={zDepth}
            rounded={false}
            ...
            style={Object.assign(
              styles.root,
              openSecondary && styles.rootWhenOpenRight, containerStyle
            )}
          >
            {children}
          </Paper>
