...
@withRouter
class IPClickAnalysis extends Component {
  static propTypes = {
  ...
  onSearchSubmit(keyword) {
    ...
    this.props.history.push(`/analysis/ip/clickStream/${encodeURIComponent(keyword)}`);
  ...
  setSelectCol(selectCol) {
    ...
    let stream = [];
    const countList = {};
    const key = (selectCol === 'USER' ? 'uid' : AnalysisMap[selectCol]);
      ...
      <div className="wd-ip-analyze container">
        ...
        >
          <div
            ...
            onClick={() => {
              history.push(`/analysis/ip/${encodeURIComponent(this.props.match.params.key)}?timestamp=${timestamp}`);
            }}
            role="presentation"
          >
...
export default IPClickAnalysis;
